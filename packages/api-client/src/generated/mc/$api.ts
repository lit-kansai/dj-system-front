...
import type { Methods as Methods11 } from './user/link/spotify'
import type { Methods as Methods12 } from './user/link/spotify/callback'
import type { Methods as Methods13 } from './user/playlist'
import type { Methods as Methods14 } from './user/playlist/_provider@string'
import type { Methods as Methods15 } from './user/playlist/_provider@string/_playlist_id@string'
        ...
        _provider: (val2: string) => {
          ...
          return {
            ...
            post: (option: { body: Methods14['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods14['post']['resBody'], BasicHeaders, Methods14['post']['status']>(prefix, prefix2, POST, option).json(),
            /**
             * @returns 要求に成功した
             */
            $post: (option: { body: Methods14['post']['reqBody'], config?: T | undefined }) =>
              fetch<Methods14['post']['resBody'], BasicHeaders, Methods14['post']['status']>(prefix, prefix2, POST, option).json().then(r => r.body),
            $path: () => `${prefix}${prefix2}`
          }
        },
        /**
