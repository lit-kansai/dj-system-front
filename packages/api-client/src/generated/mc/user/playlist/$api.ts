...
import type { Methods as Methods1 } from './_provider_name@string'
import type { Methods as Methods2 } from './_provider_name@string/_playlist_id@string'
