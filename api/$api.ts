...
import type { Methods as Methods16 } from './mc/user/playlist/_provider@string'
import type { Methods as Methods17 } from './mc/user/playlist/_provider@string/_playlist_id@string'
import type { Methods as Methods18 } from './room/_roomId@string'
import type { Methods as Methods19 } from './room/_roomId@string/music/search'
import type { Methods as Methods20 } from './room/_roomId@string/music/top'
import type { Methods as Methods21 } from './room/_roomId@string/request'
