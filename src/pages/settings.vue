<template>
  <div>
    <p class="text-h5 text-weight-bold q-mb-xs">外部サービス連携</p>
    <p class="q-mb-lg">
      AppleMusicやSpotifyとサービス連携を行うことで、リクエストされた曲が自動でプレイリストに追加されるようになります。
    </p>
    <p class="text-h6 text-weight-bold q-mb-xs">Apple Music</p>
    <p class="q-mb-sm">AppleMusicのサブスクへの登録が必要になります。</p>
    <q-btn color="primary" class="q-mb-lg" label="AppleMusicにログイン" />

    <p class="text-h6 text-weight-bold q-mb-xs">Spotify</p>
    <p class="q-mb-sm">
