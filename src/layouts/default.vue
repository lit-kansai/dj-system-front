      ...
      <div class="column q-px-lg justify-between window-height">
        <div class="q-pt-xl">
          <div class="column q-pb-xl items-start">
            ...
            <NuxtLink to="/room/:id8" target="blank" style="text-decoration: none;" class="full-width">
        ...
        <div class="column">
          <NuxtLink to="https://open.spotify.com/" target="blank" style="text-decoration: none;">
            <div class="q-pb-md">
